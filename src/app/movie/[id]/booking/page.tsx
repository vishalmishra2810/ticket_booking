...
export default function BookingPage() {
  ...
  const { selectedMovie, selectedShowtime, selectedSeats, clearBooking } =
    useBooking();
  ...
  return (
    <ProtectedRoute fallbackMessage="Please sign in to complete your booking.">
      <Container maxWidth="md" sx={{ py: 4 }}>
        ...
        <Paper elevation={3} sx={{ p: 4, mb: 3 }}>
          ...
          <Box sx={{ mb: 3 }}>
            <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
              ...
              <Typography variant="body1">
                <strong>Date & Time:</strong> {selectedShowtime.date} at{" "}
          ...
          <Box>
            ...
            >
              <Typography variant="body1">
                Ticket Price ({selectedSeats.length} seats)
              </Typography>
